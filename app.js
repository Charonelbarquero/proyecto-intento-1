...
function evaluarMensaje(senderID, messageText){
	...
	if(isContain(messageText,'13')){
		mensaje = 'dijiste 13 bro'
	}else if(isContain(messageText,'info')){
		mensaje = 'si precisa mas informacion pude dirigirse al centro interno'
...
function elementTemplate(){
	return {
		title: "los pollos hermanos family",
		subtitle: "my name is gustavo",
		item_url: "http://youtube.com",
		image_url: "https://img.youtube.com/vi/4V5pkAUFmE0/mqdefault.jpg",
		buttons: [
			buttonTemplate('Contactame','http://youtube.com'),
			buttonTemplate('Portafolio','http://youtube.com')
		]
	}
}
	...
	var messageData = {
		...
		message:{
			attachment:{
				type: "image",
				payload: {
					url: 'https://img.youtube.com/vi/4V5pkAUFmE0/mqdefault.jpg'
				}
